//creato classe parametri e classe Boid con metodi volo e bordi ed errori
#include <vector>
#include <iostream>
#include <fstream>
#include <cmath>
...
public: 
parametri(double s, double a, double c, double d_s, double d, int num_piccioni)
...
double d(){return d_;}
int num_piccioni(){return num_piccioni_;}
};
...
class Boid {
 ...
 double v_y_{};
public: 
Boid(double x, double y, double v_x, double v_y) : x_{x}, y_{y}, v_x_{v_x}, v_y_{v_y} { 
if(x>1000 | x<0){ 
...
double x(){return x_;}
double y(){return y_;}
double v_x(){return v_x_;}
double v_y(){return v_y_;} 

//std::vector<Boid> volo(std::vector<Boid> flock, parametri k){
Boid volo(Boid b, std::vector<Boid> flock, parametri k){
